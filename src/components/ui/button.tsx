  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-lg text-sm font-medium transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        outline:
          "border border-border bg-background hover:bg-slate-100 hover:text-text-primary",
        secondary:
          "bg-secondary text-white hover:bg-emerald-600 shadow-sm",
        ...
        {isLoading ? (
          ...
          >
            ...
            <path
              ...
              fill="currentColor"
              d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 2.042.764 3.902 2.016 5.317l1.984-1.984z"
            />
          </svg>
        ) : null}
        {children}
